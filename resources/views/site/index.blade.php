...
<body>
        ...
        <div class="tm-top-container">
            ...
            <nav id="tmNav" class="tm-nav">
                ...
                <ul class="tm-nav-links">
                    ...
                    <li class="tm-nav-item">
                        <a href="#" id="vehiclePage" data-linkid="2" data-align="middle"
                            class="tm-nav-link">Vehicles</a>
                    </li>
                    <li class="tm-nav-item">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="editVehicleLabel">Add Vehicle</h5>
                                                ...
                                                <div class="modal-body text-dark">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" value="{{old('name')}}"
                                                            class="form-control" id="name" placeholder="nama vehicle">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="number" value="{{old('number')}}"
                                                            class="form-control" id="number" placeholder="plat number">
                                                        @error('number')
                                                        <span class="invalid-text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(old("_method") == 'PUT' && $errors->any())
            // $('#addVehicle').modal('show')
            console.log('aaaa');
            @elseif($errors->any())
            $('#vehiclePage').trigger('click');
            $('#addVehicle').modal('show')
            @endif
        });
